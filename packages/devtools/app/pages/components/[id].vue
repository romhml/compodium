...
import type { ComponentMeta, CompodiumHooks } from 'compodium'
...
watch([exampleMeta, componentMeta], async ([newExampleMeta, newComponentMeta], [oldExampleMeta, oldComponentMeta]) => {
  ...
  compodiumDefaultProps.value = { ...(newExampleMeta?.meta?.compodium?.defaultProps ?? newComponentMeta?.meta?.compodium?.defaultProps) }
